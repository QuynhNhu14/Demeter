...
namespace Demeter.Migrator.Postgres
{
    ...
    [Migration("20240609122520_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Demeter.Core.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Demeter.Core.Entities.RoleClaims", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Demeter.Core.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Demeter.Core.Entities.UserClaims", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Demeter.Core.Entities.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Demeter.Core.Entities.UserTokens", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Demeter.Core.Entities.Orders", b =>
                {
                    b.HasOne("Demeter.Core.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Demeter.Core.Entities.Products", b =>
                {
                    ...
                    b.HasOne("Demeter.Core.Entities.User", "Vendor")
                        .WithMany()
            ...
            modelBuilder.Entity("Demeter.Core.Entities.RoleClaims", b =>
                {
                    b.HasOne("Demeter.Core.Entities.Role", "Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Demeter.Core.Entities.UserClaims", b =>
                {
                    b.HasOne("Demeter.Core.Entities.User", "Identity")
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Demeter.Core.Entities.UserTokens", b =>
                {
                    b.HasOne("Demeter.Core.Entities.User", null)
                        .WithMany("Tokens")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
