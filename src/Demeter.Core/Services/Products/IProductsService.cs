...
public interface IProductsService
{
    ...
    ValueTask<ICollection<(Domain.Products, int?)>> GetAllWithDiscount();
    ValueTask<(Domain.Products, int?)> GetByIdWithDiscount(string id);
    ...
    ValueTask AddAsync(Domain.ProductsInfo product);
