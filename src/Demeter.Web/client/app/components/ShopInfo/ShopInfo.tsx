...
const ShopDetails = {
    ...
    description: "Tại đây, bạn sẽ tìm thấy đa dạng các loại rau, trái cây, thực phẩm chế biến và các sản phẩm nông nghiệp khác, đảm bảo mang đến sự hài lòng cho vị giác và sức khỏe của bạn.",
    ...
    return (
        <Flex className="ShopInfo" vertical>
            <Flex className="ShopInfo--description" vertical gap="middle" align="center">
                ...
                <span style={{fontWeight: 'bolder', fontSize: '20px', color: '#009f7f'}}>{ShopDetails.name}</span>
            ...
            <Flex className="ShopInfo--details" vertical justify="center" gap="large">
                ...
                <Flex vertical gap="small">
                    ...
                    <Flex justify="space-between">
                        ...
                        <a href={ShopDetails.website} style={{fontWeight: 'bolder', color:'#009f7f'}}>Truy cập web</a>
                    </Flex>
                </Flex>
            </Flex>
        </Flex>
