  ...
  return (
    <div style={{ padding: 20, fontFamily: 'sans-serif' }}>
        <div style={{ marginBottom: '16px' }}>
            <Text strong style={{ fontSize: '20px', fontWeight: 'bold' }}>Add Product</Text>
        </div>
        <Divider dashed />
        {/* form ảnh  */}
        <Form.Item >
            <div style={{ display: 'flex', alignItems: 'flex-start',justifyContent: 'space-between' }}>
                <div style={{ width: '330px', marginRight: '20px' }}>
                    <Text strong style={{ fontSize: '20px', fontWeight: 'bold' }}>Featured Image</Text>
                    <div>
                    <Text style={{ fontSize: '16px' }}>
                        Upload your product featured image here. Image size should not be more than <Text strong style={{ fontSize: '16px' }}>2048 MB</Text>
                    </Text>
                    </div>
                </div>
                <div style={{ backgroundColor:'#fff', padding:'30px', borderRadius:'8px', border: '2px solid #E5E7EB', boxShadow: '0px 1px 2px 0px rgba(0, 0, 0, 0.05)'}}>
                    ...
                    <p className="ant-upload-text">Upload an image or drag and drop PNG, JPG</p>
                    </Dragger>
                </div>
            </div>
            </Form.Item>
        ...
        <Form.Item >
            <div style={{ display: 'flex', alignItems: 'flex-start',justifyContent: 'space-between' }}>
                <div style={{ width: '330px', marginRight: '20px' }}>
                    <Text strong style={{ fontSize: '20px', fontWeight: 'bold' }}>Gallery</Text>
                    <div>
                    <Text style={{ fontSize: '16px' }}>
                        Upload your product image gallery here. Image size should not be more than <Text strong style={{ fontSize: '16px' }}>2048 MB</Text>
                    </Text>
                    </div>
                </div>
                <div style={{ backgroundColor:'#fff', padding:'30px', borderRadius:'8px', border: '2px solid #E5E7EB', boxShadow: '0px 1px 2px 0px rgba(0, 0, 0, 0.05)'}}>
        ...
        <Form.Item label="Categories" name="categories" layout="vertical">
