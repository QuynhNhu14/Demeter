...
export const Footer = () => {
    return (
        <Flex className="footer" justify="space-around">
            <Flex style={{flex: '4'}} vertical justify="center" align="center" gap="middle">
                <img src={logo} alt="logo" style={{width: '120px', height: '120px'}}/>
                <span  className="footer--link"  style={{fontWeight: 'bolder'}}>Trường Đại học Bách Khoa ĐHQG - HCM</span>
                ...
                <Flex gap="small" style={{color: '#009f7f'}}>
                    <span><FacebookOutlined style={{fontSize: '20px'}}/></span>
                    <span><TwitterOutlined style={{fontSize: '20px'}}/></span>
                    <span><InstagramOutlined style={{fontSize: '20px'}}/></span>
                </Flex>
            </Flex>
            <Flex style={{flex: '2'}} vertical gap="middle">
                <span  className="footer--title">Khám phá</span>
                <NavLink to="/shops" className="footer--link" >Cửa hàng</NavLink>
                <NavLink to="/shops" className="footer--link">Phiếu giảm giá</NavLink>
                <NavLink to="/shops" className="footer--link">Flash sale</NavLink>
                <NavLink to="/shops" className="footer--link">Tác giả</NavLink>
            </Flex>
            ...
            <Flex style={{flex: '3'}} vertical gap="middle">
                ...
                <span>Đăng ký email của bạn để nhận ngay tin tức nổi bật dựa trên sở thích cá nhân</span>
