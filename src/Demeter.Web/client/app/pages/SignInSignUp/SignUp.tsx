        ...
        step === 1 ?       
          ...
          <form onSubmit={handleOnSubmitStep2}>
            ...
            <div className="social-container">
              ...
              <span className="BackButton" style={{textDecoration: "underline"}} onClick={() => setStep(1)}>Quay lại</span>
              <input
                type="text"
                name="fullname"
              ...
              <input
                ...
                required
              />
              <Checkbox onChange={console.log}>Bạn muốn ở thành chủ cửa hàng?</Checkbox>
