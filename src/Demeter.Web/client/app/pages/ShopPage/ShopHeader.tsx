...
import { LogoutOutlined, MenuFoldOutlined, MenuUnfoldOutlined, SearchOutlined, ShopFilled, ShopOutlined, UserOutlined } from '@ant-design/icons'; // Import các biểu tượng từ Ant Design
...
export default function ShopHeader() {
  ...
  return (
    <ConfigProvider theme={{ token: { colorPrimary: '#009F7F' } }}>
        <Flex className='ShopHeader' style={{ backgroundColor: '#fff', height: '64px', display: 'flex', alignItems: 'center', borderBottom:'1px solid #E5E7EB' }}>
            ...
            <Flex style={{flex: '9', height: '100%'}} >
              ...
              <Flex style={{flex: '2', borderRight:'1px solid #e7e7e7'}} justify="center" align="center" gap='small'>
                ...
                ><ShopOutlined style={{fontSize: '20px'}}/></Flex>
                <Flex vertical>
                  <span style={{fontWeight:'500', fontSize: '16px'}}>Demeter</span>
