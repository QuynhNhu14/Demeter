...
const ItemDetail={
    ...
    categories: ["Trái cây & Rau củ", "Trái cây"],
        ...
        <div className="ProductPage">
            ...
            <div className="ProductDetail">
                ...
                <Flex className="ProductDetail--Rating" vertical gap="large">
                    <span style={{fontWeight: "bolder", fontSize: "20px"}}>Đánh giá & Nhận xét của {ItemDetail.title}</span>
                ...
                <Flex className="ProductDetail--Review" vertical>
                    <Flex className='ProductDetail--Review__title' align='center'>
                        <Flex flex='3' style={{fontWeight: "bolder", fontSize: "20px" , paddingLeft: '20px'}}>Đánh giá sản phẩm ({reviews.length})</Flex>
                    ...
                    <Flex vertical justify="flex-end" >
                        ...
                        <Flex align="center" justify="space-between">
                            <span style={{fontSize: '12px', opacity: 0.6, padding: '20px'}}>Trang 1 / 1</span>
